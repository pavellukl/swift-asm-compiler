...
int main (int argc, char *argv[]) {
   ...
   printf_stderr("This is an error to stderr, it's prefixed with \"Error: \" and it's red in the debug mode.\n");
   printf_stddebug("This is a yellow debug log to stderr. It is compiled only in the debug mode.\n");
