...
TokenData is_keyword(char* keyword, bool new_line_before_token) {
    if (strcmp(keyword, "Double") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_DOUBLE, .eol_before = new_line_before_token};
    }
    if (strcmp(keyword, "Double?") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_DOUBLE_NIL, .eol_before = new_line_before_token};
    }
    if (strcmp(keyword, "else") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_ELSE, .eol_before = new_line_before_token};
    }   
    if (strcmp(keyword, "func") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_FUNC, .eol_before = new_line_before_token};
    }   
    if (strcmp(keyword, "if") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_IF, .eol_before = new_line_before_token};
    }   
    if (strcmp(keyword, "Int") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_INT, .eol_before = new_line_before_token};
    }
    if (strcmp(keyword, "Int?") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_INT_NIL, .eol_before = new_line_before_token};
    }    
    if (strcmp(keyword, "let") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_LET, .eol_before = new_line_before_token};
    }   
    if (strcmp(keyword, "nil") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_NIL, .eol_before = new_line_before_token};
    }
    if (strcmp(keyword, "return") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_RETURN, .eol_before = new_line_before_token};
    }   
    if (strcmp(keyword, "String") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_STRING, .eol_before = new_line_before_token};
    } 
    if (strcmp(keyword, "String?") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_STRING_NIL, .eol_before = new_line_before_token};
    }  
    if (strcmp(keyword, "var") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_VAR, .eol_before = new_line_before_token};
    }   
    if (strcmp(keyword, "while") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_WHILE, .eol_before = new_line_before_token};
    }
    if (strcmp(keyword, "true") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_TRUE, .value.boolean = true, .eol_before = new_line_before_token};
    }
    if (strcmp(keyword, "false") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_FALSE, .value.boolean = false, .eol_before = new_line_before_token};
    }
    if (strcmp(keyword, "Bool") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_BOOL, .value.boolean = true, .eol_before = new_line_before_token};
    }
    if (strcmp(keyword, "Bool?") == 0){
        return (TokenData){.type = TOKEN_KEYWORD_BOOL_NIL, .value.boolean = false, .eol_before = new_line_before_token};
    }
        ...
        switch(current_state){
            ...
            case IDENTIF:
                ...
                if (token.type != TOKEN_IDENTIF) {
                    ...
                    token.value.string = (char*)malloc(sizeof(char) * (strlen(b_buffer) + 1));
            ...
            case ESCAPE_SEQUENCE:
                if (current_char == '\\' || current_char == '"' || current_char == 'n' || current_char == 'r' || current_char == 't') {
                    b_buffer[buffer_index++] = current_char;
                    current_state = STRING;
                }
